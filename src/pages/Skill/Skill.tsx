...
import { useDeleteSkillMutation, useGetSkillQuery } from "../../redux/api/baseApi"; // Import your delete mutation
import {
    Table,
    TableBody,
    TableCaption,
...
const Skill = () => {
    ...
    const [deleteProject] = useDeleteSkillMutation(); // Mutation for deleting a project
    ...
    return (
        <div>
            ...
            <Table>
                <TableCaption>A list of my Skill</TableCaption>
                <TableHeader>
                    <TableRow>
